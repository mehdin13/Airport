...
namespace AirportWebRazor.Pages.Places.CofeeShop
{
    public class CreatecshtmlModel : PageModel
    {
        ...
        public CreatecshtmlModel(IPlace place, IAddress address, ICategory category, IGallery gallery, IGalleryImage galleryImage, IDetail detail, IFeatrue featrue, IDetailValue detailValue, ICity city, IState state, IAirPort airPort, ICustomer customer)
        {
            _place = place;
            _address = address;
            _category = category;
        ...
        public async Task<IActionResult> OnGet()
        {
            ...
            ViewData["Feathrue"] = _featrue.ToListbyid(18);
