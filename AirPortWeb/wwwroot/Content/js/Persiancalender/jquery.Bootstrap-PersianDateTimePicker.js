      ...
      return this.each(function () {
        ...
        if (settings.InLine) {
          ...
          $this.popover({
            ...
            title: 'انتخاب تاریخ',
            trigger: 'manual',
            template: '<div class="popover zIndexCorrected" role="tooltip"><div class="arrow"></div><h3 class="popover-header" data-name="md-datetimepicker-title" data-isgregorian="' + settings.IsGregorian + '"></h3><div class="popover-body" data-name="md-datetimepicker-popovercontent"></div></div>',
  ...
  $('html').on('click', function (e) {
    ...
    if (!$target.hasClass('popover') && // اگر روی تقویم کلیک نشده بود
      !hasFlag && // اگر فلگ نداشت
        $target.parents('.popover.show').length == 0) // اگر روی تقویم کلیک نشده بود
